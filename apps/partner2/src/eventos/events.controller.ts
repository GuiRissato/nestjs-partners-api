...
export class EventosController {
  ...
  @Post()
  create(@Body() criarEventoDto: CriarEventoRequest) {
    return this.eventsService.create({
      name: criarEventoDto.nome,
      description: criarEventoDto.descricao,
      date: criarEventoDto.data,
      price: criarEventoDto.preco,
    });
  }
  ...
  update(
    @Param('id') id: string,
    @Body() atualizarEventoDto: AtualizarEventoRequest,
  ) {
    return this.eventsService.update(id, {
      name: atualizarEventoDto.nome,
      description: atualizarEventoDto.descricao,
      date: atualizarEventoDto.data,
      price: atualizarEventoDto.preco,
    });
  }
  ...
  reserveSpots(
    ...
    return this.eventsService.reserveSpots({
      eventId,
